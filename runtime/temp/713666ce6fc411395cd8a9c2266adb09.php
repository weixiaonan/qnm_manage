<?php /*a:1:{s:66:"D:\phpStudy\WWW\qnm_manage\application\admin\view\index\index.html";i:1555471542;}*/ ?>
...
<div class="layui-layout layui-layout-admin layui-fluid larryms-layout" data-layout="tab" id="larry_layout">
    ...
    <div class="layui-header larryms-header" id="larry_head">
        <div class="larryms-topbar-left" id="topbarL">
            ...
            <a class="layui-logo larryms-logo">LarryMS</a>
                ...
                <ul class="layui-nav clearfix" id="topbarRMenu">
                    <li class="layui-nav-item layout-switch">
                        ...
                        <dl class="layui-nav-child">
                            <dd class="layui-this"><a data-href="/qnm_manage/static/admin/html/larryMS210.html" data-text="选项卡式布局">选项卡式布局</a></dd>
                            <dd><a data-href="/qnm_manage/static/admin/html2/index.html" data-text="无选项卡布局">无选项卡布局</a></dd>
